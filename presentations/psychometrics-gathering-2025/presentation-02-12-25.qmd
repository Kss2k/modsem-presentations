...
- `modsem` builds the product indicators and model specification automatically.
- This automation is critical because PI model constraints become exponentially more complicated as
  the number of indicators or interaction terms grows.
...
- Pros:
    ...
    - Integrates cleanly with other `Mplus` features (e.g., multilevel SEM).
